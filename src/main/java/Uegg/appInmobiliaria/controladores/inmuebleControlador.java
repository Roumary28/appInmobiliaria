...
public class inmuebleControlador {
    ...
    @PostMapping("/creado")
    public String creado( @RequestParam(required = false) MultipartFile archivo, @RequestParam Tipo tipo, @RequestParam String ubicacion, @RequestParam (required = false) Double superficie, @RequestParam (required = false) Integer ambientes,
        ...
        try {
            if (tipoOferta.equals("venta")) {
                ...
                inmuebleServicio.crearInmueble(archivo, tipo, ubicacion, superficie, ambientes, descripcion, precioVenta, precioAlquiler, tipoOferta);
