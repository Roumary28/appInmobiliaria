...
public  class UsuarioServicio {
   ...
   @Autowired
     ...
     @Transactional
    public void crear(String nombre, String apellido, Long dni, Long idTributario, String email, String pass, String pass2, String opcion) throws MyException {
    ...
    @Transactional  
    public void modificarUsuario(String id, Integer telefono){
